:: Author: Doruk Aysor
:: Purpose: Connects This Computer To The Netwrok For Sharing & Optimizes Internet Speed
@echo off
setlocal
...
:: 1. Allowing Insecure Guest Auth (Required for Win 11 Password-less shares)
...
:: Disabling Auto-Tuning to prevent buffer bloat
